                ...
                <div class="print" style="border:1px solid #000; padding-left:5px; padding-right:5px; padding-bottom:5px; padding-top:5px;">   
                    <div class="printableArea">
                        <div class="id-card-holder">
                            <div class="id-card">
                                <div class="header">
                                    <img src="<?php echo base_url();?>uploads/logo.png" style="max-width:100px; max-height:100px; margin-top:0;" >
                                ...
                                <h2 style="line-height: 15px;"><?php echo $student_name;?></h2>
                                <div class="qr-code" style="padding: 5px;">
